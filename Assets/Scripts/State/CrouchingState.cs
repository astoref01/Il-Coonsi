...
public class CrouchingState : State
{
    ...
    public override void HandleInput()
    {
        ...
        // Verifica se il tasto di crouch è ancora premuto
    ...
    public override void LogicUpdate()
    {
        ...
        // Se il tasto di crouch non è premuto e non c'è un ostacolo sopra il personaggio, cambia stato a standing
        if (!crouchHeld && !belowCeiling)
        {
            Debug.Log("Changing State to Standing");
            stateMachine.ChangeState(character.standing);
        }
        else if (crouchAction.triggered)
        {
            Debug.Log("Crouch action triggered, changing state to Standing");
            stateMachine.ChangeState(character.standing);
        }
    }
