...
public class QTEEvent : MonoBehaviour
{
    ...
    public List<QTEKey> keys = new List<QTEKey>(); // Lista dei tasti per il QTE
    ...
    [HideInInspector]
    public bool hasEnded = false;  // Aggiungi questa variabile per tracciare se il QTE è finito

    public void FailEvent()
    {
        onFail.Invoke(); // Chiama l'evento onFail quando il QTE fallisce
    }
}